...
export const patientTestsTable = env.DYNAMODB_TABLE_PATIENT_TESTS || "patient tests table";
export const bookingSlotsTable = env.DYNAMODB_TABLE_BOOKING_SLOTS || "booking slots table";
